...
export default function Projects() {
  return (
    ...
    >
      <h2 className="text-5xl text-gray-700 font-bold text-center">
        My Projects
      </h2>

      {/* <div
        className="p-10 bg-gary-500 flex flex-col justify-center items-center
         gap-5 lg:flex-row max-w-4xl mx-auto shadow transition 
